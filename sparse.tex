...
\usepackage{fancyhdr}
\pagestyle{fancy}
\rhead{\href{http://dx.doi.org/10.1002/9783527680863.ch14}{doi:10.1002/9783527680863.ch14}}
...
\centering{%
\begin{tikzpicture}%[scale=1, font=\sffamily]%,every node/.style={minimum size=1cm},on grid]
\node [anchor=north west] (b) at (0, .382\textwidth) {\includegraphics[width=.382\textwidth]{fig_log_gabor_filters_A}};
\node [anchor=north west] (gp) at (.382\textwidth, .38\textwidth) {\includegraphics[width=.605\textwidth]{fig_log_gabor_filters_B}};
